...
<html lang="es">
  <head>
    ...
    <title>Actividades en la Playa de Laredo – Cantabria</title>
    ...
    require $_SERVER['DOCUMENT_ROOT'] . '/turismo-norte-espana/cantabria/playadelaredo/fichas/sections/head/variables/web-playa/localizacion-playa.php';
