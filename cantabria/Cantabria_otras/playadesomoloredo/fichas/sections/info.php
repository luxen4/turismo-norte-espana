...
<?php define('SECTIONS_PATH_SECTIONS', $_SERVER['DOCUMENT_ROOT'] . '/Blog_Playas2026/cantabria/playadeostende/fichas/sections/variables/'); ?>
...
<?php require SECTIONS_PATH_SECTIONS. 'servicios'.$nombre_playa_region.'.php'; ?>
