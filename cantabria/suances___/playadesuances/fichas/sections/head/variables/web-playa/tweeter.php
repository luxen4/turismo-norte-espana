<?php
// Variables de configuración para la Playa de Suances
...
$twiterCards_url = '<?= PATH_DOMINIO_RAIZ; ?>/turismo-norte-espana/cantabria/playadesuances/fichas/playa-de-suances.php?i=1';
?>