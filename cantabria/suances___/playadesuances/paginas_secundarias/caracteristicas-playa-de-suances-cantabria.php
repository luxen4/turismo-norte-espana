...
<head>
  ...
  <title>Playa de Suances en Suances</title>
  <!-- Bootstrap 5 -->
...
<section class="py-5">
  <div class="container">
    <header class="text-center mb-5">
      <h2 class="text-primary">🏖️ Playa de Suances - Suances</h2>
      <p class="lead">Una de las playas más completas y accesibles del norte de España</p>
    </header>

    <div class="beach-info">
      <p>La <strong>Playa de Suances</strong>, situada en el municipio de <strong>Suances</strong> (Cantabria), es uno de los arenales más completos y accesibles del norte de España. A continuación, te detallamos sus principales características:</p>

      <ul class="list-unstyled">
        <li><i class="fas fa-sand" style="color: #e67e22;"></i> <strong>Arena:</strong> fina y dorada, ideal para familias con niños.</li>
        <li><i class="fas fa-ruler-combined" style="color: #3498db;"></i> <strong>Longitud:</strong> aproximadamente <time datetime="2025-01-01">1.400 metros</time>.</li>
        <li><i class="fas fa-expand-arrows-alt" style="color: #1abc9c;"></i> <strong>Anchura:</strong> hasta 120 metros en marea baja.</li>
