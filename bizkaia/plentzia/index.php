...
<?php define('LUGAR', "Plentzia"); ?>
<?php define('LUGAR_MINUSCULA', 'plentzia') ?>
<?php define('KEYWORDS_CONTENT', 'Plentzia, Bizkaia, playa Plentzia, turismo Bizkaia, naturaleza Euskadi, costa vasca') ?>
        ...
        <header class="mb-10">
          <div class="bg-gradient-to-r from-blue-600 via-sky-500 to-cyan-400 text-white text-center p-8 rounded-lg shadow-lg">
            <h1 class="text-3xl md:text-5xl font-extrabold mb-3 flex justify-center items-center gap-3">
              <i class="fas fa-map-marker-alt"></i> Plentzia (Bizkaia)
            </h1>
            <p class="text-left text-lg md:text-xl font-medium">
              Plentzia es un tranquilo municipio costero en Bizkaia, conocido por sus amplias playas y su ambiente familiar en la costa vasca.
            </p>
          </div>
        </header>
