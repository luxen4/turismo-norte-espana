...
<head>
    ...
    <title>Popup cada 5 segundos</title>
    <style>
        #imagePopup {
            display: none;
            position: fixed;
...
<body>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            const images = [
                'https://Playas2026.kesug.com/Blog_Playas2026/cantabria/playadeostende/img/playa-de-ostende-castro-urdiales-cantabria.jpg',
